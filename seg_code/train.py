...
def train(args):
    ...
    train_data = load_data('/mnt/hdd/karmpatel/naman/demo/cityscapes/small_dataset/train', num_workers=4, transform=transform)
    valid_data = load_data('/mnt/hdd/karmpatel/naman/demo/cityscapes/small_dataset/valid', num_workers=4)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir' , default= "/raid/home/namanmalpani/final_yr/SemanticSegmentationCityscapes/debug" )
    # Put custom arguments here
    parser.add_argument('-m', '--model', choices=['my_fcn', 'unet', 'deeplab'], default='unet')
